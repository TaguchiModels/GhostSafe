...
[初期設定](#初期設定)  
[パスワードの設定](#パスワードの設定)  
[ダウンロードフォルダーの設定](#ダウンロードフォルダーの設定)  
[暗号化フォルダーの場所の設定](#暗号化フォルダーの場所の設定)  
[設定を保存する](#設定を保存する)  
[フォルダの作成、変更、削除](#フォルダの作成、変更、削除)  
[ファイルの暗号化](#ファイルの暗号化)  
[ファイル名の変更や削除](#ファイル名の変更や削除)  
[ファイルの移動](#ファイルの移動)  
[ファイルのダウンロード](#ファイルのダウンロード)  
[動画ファイルの再生](#動画ファイルの再生)  
[静止画像の表示](#静止画像の表示)  
[ファイル更新時の暗号化](#ファイル更新時の暗号化)  
[表示切替](#表示切替)  
[設定](#設定)  
[言語の切替](#言語の切替)  
[複数のPCでGhostSafeを使うとき](#複数のPCでGhostSafeを使うとき)  
...
<img src="images/DotNet8Download.png">  

Windows 欄の x64 をクリックするとダウンロードできます。  
<img src="images/DotNet8DownloadWebsite.png" style="width:600px;">  
...
## サムネイル画像サイズの選択  
５種類の画像サイズを選択できます。これは随時変更することが出来ます。  
